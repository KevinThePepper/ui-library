...
export declare const onClickOrEnterDefault: <TElement extends HTMLElement>(event: React.KeyboardEvent<TElement> | React.MouseEvent<TElement, globalThis.MouseEvent>, cb?: IOnClickOrEnterHandler<TElement>) => void;
